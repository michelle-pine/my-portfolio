...
export class AboutService {
  ...
  constructor() { 
    this.skills = [
      new Skillset("Languages", ["Ruby", "Java", "Javascript", "PostgreSQL", "R", "Python", "Typescript", "HTML", "CSS", "SCSS", "LESS", "Racket", "Command Line"], "fa fa-code"),
      new Skillset("Libraries", ["Bootstrap", "Angular", "React", "p5"], "fa fa-file-archive-o"),
