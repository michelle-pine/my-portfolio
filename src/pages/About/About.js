    ...
    <div className="page about-page">
      ...
      <div className="about-bio">
        ...
        <div className="about-bio-info">
          <strong>My name is Michelle Pine. I'm a Boston-based developer, designer, video editor, aspiring writer, and incurable dog-lover!</strong>
          <p>As a computer scientist and designer, I'm constantly exploring ways to use code and visuals to display my ideas in creative and exciting ways. I generally focus on front-end development and UI/UX design, but I have back-end development experience as well. Check out my <Link to="/">projects</Link> for a taste of what I've done so far.</p>
      ...
      <div className="leadership-set">
        ...
        <Experience organization="Khoury College Student Advisory Board" position="Member" year="2019-present"></Experience>
