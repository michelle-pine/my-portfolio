...
class Contact extends React.Component {
  ...
  componentDidMount() {
    $("#loader").addClass("solid").fadeIn().delay(2500).fadeOut();
    $(".contact-page").delay(2500).css("overflow","auto");
  }
  ...
  render() {
    ...
    <div className="page contact-page">
      ...
      <div className="contact-form">
        <iframe seamless="seamless" scrolling="no" className="contact-frame" width="100%" height="900" allowTransparency="true" id="contactform123" name="contactform123" marginwidth="0" marginheight="0" frameborder="0" src="//www.123formbuilder.com/my-contact-form-5218252.html">
          <p>
