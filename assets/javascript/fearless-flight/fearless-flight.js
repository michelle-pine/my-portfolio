...
function preload() {
  bgnew = loadImage("./assets/javascript/data/bgnew.png");
  bgnew2 = bgnew;
  main = loadSound('./assets/javascript/data/mainTitle1.mp3');

  loop1 = loadSound('./assets/javascript/data/sLoop1.mp3');
  shoot = loadSound('./assets/javascript/data/gun.mp3');
  boom = loadSound('./assets/javascript/data/explosion.mp3');
  click = loadSound('./assets/javascript/data/click.mp3');
  island = loadImage("./assets/javascript/data/island.png");
  gameover = loadImage("./assets/javascript/data/gameover.png");
  gamewon = loadImage("./assets/javascript/data/youwon.png");
  gameover = loadImage("./assets/javascript/data/gameover.png");
  redPlane = loadImage("./assets/javascript/data/Asset 2.png");
  bluePlane = loadImage("./assets/javascript/data/Asset 3.png");
  greenPlane = loadImage("./assets/javascript/data/Asset 4.png");
  myPlane = redPlane;
  birdImg0 = loadImage("./assets/javascript/data/Asset 11.png");
  birdImg1 = loadImage("./assets/javascript/data/Asset 12.png");
  birdImg2 = loadImage("./assets/javascript/data/Asset 13.png");
  birdImg3 = loadImage("./assets/javascript/data/Asset 14.png");
  birdImg4 = loadImage("./assets/javascript/data/Asset 15.png");
  birdImg5 = loadImage("./assets/javascript/data/Asset 16.png");
  birdImg6 = loadImage("./assets/javascript/data/Asset 17.png");
  birdImg7 = loadImage("./assets/javascript/data/Asset 18.png");
  badPlane = loadImage("./assets/javascript/data/Asset 8.png");
  sprites = [birdImg0, birdImg1,
    birdImg2, birdImg3, birdImg4, birdImg5, birdImg6,
    birdImg7, birdImg6, birdImg5, birdImg4, birdImg3,
    birdImg2, birdImg1
  ];
  exp1 = loadImage("./assets/javascript/data/exp4.png");
  exp2 = loadImage("./assets/javascript/data/exp3.png");
  exp3 = loadImage("./assets/javascript/data/exp1.png");
  exp4 = loadImage("./assets/javascript/data/exp5.png");
  exp5 = loadImage("./assets/javascript/data/exp6.png");
  exp6 = loadImage("./assets/javascript/data/exp8.png");
  expSprites = [exp1, exp2, exp3, exp4, exp5, exp6];
  titleScreen = loadImage("./assets/javascript/data/TITLEpng.png");
  t1 = loadImage("./assets/javascript/data/t1.png");
  t2 = loadImage("./assets/javascript/data/t2.png");
  tutorial = t1;

  redEasyBoth = loadImage("./assets/javascript/data/redEasyBoth.png");
  redEasyPlanes = loadImage("./assets/javascript/data/redEasyPlanes.png");
  redEasyBirds = loadImage("./assets/javascript/data/redEasyBirds.png");
  redMediumBoth = loadImage("./assets/javascript/data/redMediumBoth.png");
  redMediumPlanes = loadImage("./assets/javascript/data/redMediumPlanes.png");
  redMediumBirds = loadImage("./assets/javascript/data/redMediumBirds.png");
  redHardBoth = loadImage("./assets/javascript/data/redHardBoth.png");
  redHardPlanes = loadImage("./assets/javascript/data/redHardPlanes.png");
  redHardBirds = loadImage("./assets/javascript/data/redHardBirds.png");
  ...
  greenEasyBoth = loadImage("./assets/javascript/data/greenEasyBoth.png");
  greenEasyPlanes = loadImage("./assets/javascript/data/greenEasyPlanes.png");
  greenEasyBirds = loadImage("./assets/javascript/data/greenEasyBirds.png");
  greenMediumBoth = loadImage("./assets/javascript/data/greenMediumBoth.png");
  greenMediumPlanes = loadImage("./assets/javascript/data/greenMediumPlanes.png");
  greenMediumBirds = loadImage("./assets/javascript/data/greenMediumBirds.png");
  greenHardBoth = loadImage("./assets/javascript/data/greenHardBoth.png");
  greenHardPlanes = loadImage("./assets/javascript/data/greenHardPlanes.png");
  greenHardBirds = loadImage("./assets/javascript/data/greenHardBirds.png");
  ...
  blueEasyBoth = loadImage("./assets/javascript/data/blueEasyBoth.png");
  blueEasyPlanes = loadImage("./assets/javascript/data/blueEasyPlanes.png");
  blueEasyBirds = loadImage("./assets/javascript/data/blueEasyBirds.png");
  blueMediumBoth = loadImage("./assets/javascript/data/blueMediumBoth.png");
  blueMediumPlanes = loadImage("./assets/javascript/data/blueMediumPlanes.png");
  blueMediumBirds = loadImage("./assets/javascript/data/blueMediumBirds.png");
  blueHardBoth = loadImage("./assets/javascript/data/blueHardBoth.png");
  blueHardPlanes = loadImage("./assets/javascript/data/blueHardPlanes.png");
  blueHardBirds = loadImage("./assets/javascript/data/blueHardBirds.png");
